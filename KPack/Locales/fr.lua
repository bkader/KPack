...
L["show minimap"] = "afficher la mini-carte"
L["hide minimap"] = "cacher la mini-carte"
L["hide zone text"] = "cacher le texte de zone"
L["change minimap scale"] = "changer l'échelle de la mini-carte"
L["toggle hiding minimap in combat"] = "cacher la mini-carte pendant le combat"
L["minimap shown."] = "Minicarte affichée."
L["minimap hidden."] = "Minicarte caché."
L["hide in combat: %s"] = "cacher pendant le combat: %s"
L["lock the minimap"] = "verrouiller la mini-carte"
L["minimap locked."] = "Minicarte verrouillée."
L["unlocks the minimap"] = "déverrouiller la mini-carte"
L["minimap unlocked. Hold SHIFT+ALT to move it."] = "mini-carte déverrouillée. maintenez MAJ+ALT pour la déplacer."
L["Once unlocked, the minimap can be moved by holding both SHIFT and ALT buttons."] = "Une fois déverrouillée, la mini-carte peut être déplacée en maintenant MAJ et ALT."
L["Lock Minimap"] = "Verrouiller la Minicarte"
L["Hide Minimap"] = "Cacher la Minicarte"
L["Hide Zone Text"] = "Cacher le texte de zone"
L["Hide in combat"] = "Cache en combat"
-- Minimap Button
L["Minimap Button"] = "Bouton de mini-carte"
L["Shows the minimap icon button."] = "Montre le bouton de la mini-carte."
