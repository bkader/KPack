...
function mod:CreateFrames()
    ...
    _G.EnhancedStackSplitAutoSplitButton:SetWidth(ceil(_G.EnhancedStackSplitAutoSplitButton:GetTextWidth()) + 10)
...
function mod:ModeSettings(mode)
    ...
    if mode == 3 then
        ...
        _G.EnhancedStackSplitTextAutoText1:SetText(
            "|cffffffff" .. L["Free Bag Slots"] .. ":|r |cffff8000" .. getFreeBagSlots() .. "|r"
        )
...
function mod:AutoSplitInfo(num)
    ...
    _G.EnhancedStackSplitTextAutoText2:SetText(
        "|cffffffff" ..
            maxstacksize ..
                " | |cffff8000" ..
                    numstacks .. "|cffffffffx " .. num .. " | " .. L["leftover"] .. "=" .. leftover .. "|r"
    )
end
