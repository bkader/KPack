...
KPack:AddModule(
	"Target Percent",
	"Adds a health percentage to the Blizzard target and focus target frames.",
	function(folder, core)
		if core:IsDisabled("Target Percent") then return end
	    ...
	    core:RegisterCallback("PLAYER_ENTERING_WORLD", function()
	        ...
	        focusPercent:SetScript("OnShow", function() focusPercent:RegisterEvent("UNIT_HEALTH") end)
	        focusPercent:SetScript("OnHide", function() focusPercent:UnregisterEvent("UNIT_HEALTH") end)
