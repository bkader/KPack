...
title:SetText("|cff69ccf0K|r|caaf49141Pack|r - SnowfallKeyPress")
...
local addAllButton = CreateFrame("Button", nil, configFrame, "UIPanelButtonTemplate")
...
local subButton = CreateFrame("Button", nil, configFrame, "UIPanelButtonTemplate")
...
local subAllButton = CreateFrame("Button", nil, configFrame, "UIPanelButtonTemplate")
...
local clearAllButton = CreateFrame("Button", nil, configFrame, "UIPanelButtonTemplate")
...
local resetDefaultButton = CreateFrame("Button", nil, configFrame, "UIPanelButtonTemplate")
